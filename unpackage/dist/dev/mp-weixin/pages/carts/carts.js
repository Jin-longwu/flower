...

{
  ...
  (0, _vuex.mapMutations)({
    ...
    swipeClick: function swipeClick(index) {var _this = this;
      uni.showModal({
        title: '提示',
        content: '是否删除',
    ...
    changeBoxall: function changeBoxall() {
    ...
    getProducts: function getProducts() {var _this2 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var randomnum, result;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
                randomnum = parseInt(Math.random() * 14);_context.next = 3;return (
                  (0, _request.myRequestGet)(
                  "/wscshop/goods/goodsByTagAlias.json?kdt_id=10056586&alias=" + _this2.tags[randomnum]));case 3:result = _context.sent;
                if (result.code === 0) {
                  _this2.goods = [].concat(_toConsumableArray(_this2.goods), _toConsumableArray(result.data.list));
                }case 5:case "end":return _context.stop();}}}, _callee);}))();
    },
    judge: function judge() {var _this3 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2() {return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:
                if (_this3.carts.length == 0) {
                  _this3.show = true;
                } else {
                  _this3.show = false;
                }case 1:case "end":return _context2.stop();}}}, _callee2);}))();
    },
    getAccount: function getAccount() {var _this4 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee3() {var total, z;return _regenerator.default.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:
                total = 0;
                if (_this4.carts.length == 1) {
                  if (_this4.$refs.checkbox[0].checked) {
                  ...
                  for (z = 0; z < _this4.carts.length; z++) {
                    if (_this4.$refs.checkbox[z].checked) {
                      total += _this4.carts[z].sellprice * _this4.carts[z].buynum;
                    }
                  }
                } else if (_this4.carts.length == 0) {
                  total = 0;
                }
