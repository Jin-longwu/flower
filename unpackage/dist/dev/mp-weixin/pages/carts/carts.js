  ...
  (0, _vuex.mapMutations)({
    ...
    swipeClick: function swipeClick(index) {var _this = this;
      uni.showModal({
        ...
        success: function success(res) {
          if (res.confirm) {
            _this.carts[index].checked = _this.pageChecked;
            _this.account -= _this.carts[index].sellprice * _this.carts[index].buynum;
    ...
    getProducts: function getProducts() {var _this2 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var randomnum, result;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
                ...
                console.log(randomnum, "nnnnnnnnnnnnnnnnnnnnnn");_context.next = 4;return (
                  ...
                  "/wscshop/goods/goodsByTagAlias.json?kdt_id=10056586&alias=" + _this2.tags[randomnum]));case 4:result = _context.sent;
